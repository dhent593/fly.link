...
export default function FiturPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans relative overflow-hidden flex flex-col justify-between transition-colors duration-500">
      ...
      <div className="absolute top-[10%] left-[10%] w-[300px] h-[300px] bg-cyan-500/5 dark:bg-cyan-600/10 rounded-full blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-[25%] right-[10%] w-[350px] h-[350px] bg-indigo-500/5 dark:bg-indigo-600/10 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12 flex-1 relative z-10 flex flex-col justify-center animate-fade-in-up">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/15 text-[10px] text-cyan-600 dark:text-cyan-400 font-bold tracking-wider uppercase">
            Platform Fungsional
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          {/* Card 1 */}
          <div className="glass p-6 md:p-8 rounded-[28px] border border-card-border flex flex-col justify-between hover:border-cyan-500/20 dark:hover:border-white/10 hover:bg-slate-100/50 dark:hover:bg-white/[0.01] transition-all duration-300 group cursor-default">
          ...
          {/* Card 2 */}
          <div className="glass p-6 md:p-8 rounded-[28px] border border-card-border flex flex-col justify-between hover:border-purple-500/20 dark:hover:border-white/10 hover:bg-slate-100/50 dark:hover:bg-white/[0.01] transition-all duration-300 group cursor-default">
            <div className="space-y-4">
          ...
          {/* Card 3 */}
          <div className="glass p-6 md:p-8 rounded-[28px] border border-card-border flex flex-col justify-between hover:border-indigo-500/20 dark:hover:border-white/10 hover:bg-slate-100/50 dark:hover:bg-white/[0.01] transition-all duration-300 group cursor-default">
            <div className="space-y-4">
          ...
          {/* Card 4 */}
          <div className="glass p-6 md:p-8 rounded-[28px] border border-card-border flex flex-col justify-between hover:border-emerald-500/20 dark:hover:border-white/10 hover:bg-slate-100/50 dark:hover:bg-white/[0.01] transition-all duration-300 group cursor-default">
            <div className="space-y-4">
